...
use common::{Chroma, Codec, CodecDetails, ColorDepth, DecodingSpec, EncodeProfile, EncodingSpec, ThreeValue};

use crate::display::DrmDisplay;
use crate::sys::va::{VAConfigAttribType_VAConfigAttribMaxPictureHeight, VAConfigAttribType_VAConfigAttribMaxPictureWidth, VAEntrypoint_VAEntrypointEncSlice, VAEntrypoint_VAEntrypointVLD, VAProfile, VAProfile_VAProfileAV1Profile0, VAProfile_VAProfileAV1Profile1, VAProfile_VAProfileH264Baseline, VAProfile_VAProfileH264High, VAProfile_VAProfileH264High10, VAProfile_VAProfileH264Main, VAProfile_VAProfileHEVCMain, VAProfile_VAProfileHEVCMain10, VAProfile_VAProfileHEVCMain12, VAProfile_VAProfileHEVCMain422_10, VAProfile_VAProfileHEVCMain422_12, VAProfile_VAProfileHEVCMain444, VAProfile_VAProfileHEVCMain444_10, VAProfile_VAProfileHEVCMain444_12, VAProfile_VAProfileMPEG2Main, VAProfile_VAProfileMPEG4Main, VAProfile_VAProfileVC1Main, VAProfile_VAProfileVP8Version0_3, VAProfile_VAProfileVP9Profile0, VAProfile_VAProfileVP9Profile1, VAProfile_VAProfileVP9Profile2, VAProfile_VAProfileVP9Profile3};
use crate::VaError;
...
pub fn get_capabilities(display: &DrmDisplay) -> Result<Vec<CodecDetails>, VaError> {
    ...
    for profile in display.query_profiles()? {
        ...
        if entrypoints.contains(&VAEntrypoint_VAEntrypointEncSlice) {
            let attribs = display.get_config_attributes(profile, VAEntrypoint_VAEntrypointEncSlice)?;
